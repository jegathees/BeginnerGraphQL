...
namespace MyFirstGraphQL.GraphQL
{
    public class Subscription
    {
        ...
        [SubscribeAndResolve]
        public async ValueTask<ISourceStream <List<Author>>> OnAuthorsGet([Service]
        ...
        [SubscribeAndResolve]
        public async ValueTask<ISourceStream<Author>> OnAuthorGet([Service] ITopicEventReceiver
        ...
        [SubscribeAndResolve]
        public async ValueTask<ISourceStream<BlogPost>> OnBlogPostsGet([Service] ITopicEventReceiver
        eventReceiver, CancellationToken cancellationToken)
        {
            return await eventReceiver.SubscribeAsync<string,
        ...
        [SubscribeAndResolve]
        public async ValueTask<ISourceStream<BlogPost>> OnBlogPostGet([Service] ITopicEventReceiver
        eventReceiver, CancellationToken cancellationToken)
        {
            return await eventReceiver.SubscribeAsync<string,
